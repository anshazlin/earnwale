...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      {/* 2. Hero */}
      <section className="px-4 py-10 sm:py-16 md:py-20">
      ...
      {/* 3. Plans */}
      <section className="border-t border-amber-50 bg-amber-50/30 py-10 sm:py-16 md:py-20">
        <div className="mx-auto max-w-screen-md px-4">
          ...
          <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2 md:gap-8 md:max-w-4xl md:mx-auto">
            <div className="rounded-2xl border-2 border-gray-200 bg-white p-5 shadow-md sm:p-6 md:p-8">
              <div className="mb-4">
                <Image
            ...
            <div className="rounded-2xl border-2 border-amber-400 bg-white p-5 shadow-lg ring-2 ring-amber-200 sm:p-6 md:p-8">
              <div className="mb-4">
                <Image
      ...
      {/* 5. Earnings Example */}
      <section className="border-t border-amber-50 bg-amber-50/50 py-10 sm:py-16 md:py-20">
        <div className="mx-auto max-w-screen-md px-4">
          <h2 className="text-center text-xl font-bold text-gray-900 sm:text-2xl md:text-3xl">
            Your Earning Potential
          </h2>
          <div className="mx-auto mt-8 max-w-2xl rounded-2xl border border-amber-200 bg-amber-50/80 p-5 shadow-md sm:p-6 md:p-8">
      ...
      {/* 7. Secure Payment */}
      <section className="border-t border-amber-100 bg-amber-50/50 py-8 sm:py-12">
        <div className="mx-auto max-w-screen-md px-4">
          <div className="rounded-2xl border border-amber-200 bg-amber-50/80 px-4 py-4 text-center shadow-sm sm:px-6 sm:py-5">
        ...
        <div className="mx-auto max-w-screen-md px-4 sm:px-6">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-4">
            <div className="sm:col-span-2 md:col-span-1">
              <p className="text-base font-semibold text-gray-900 sm:text-lg">Earnwale</p>
              <p className="mt-2 text-sm text-gray-600">
